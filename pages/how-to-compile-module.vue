<template>
  <v-row>
    <v-col>
      ...
      <p :class="paragraph">
        This page explains how to configure and compile a module that depends on
        OpenGeode, either it is an provided module (for instance
        OpenGeode-Geosciences) or
        <a href="/how-to-create-module">your own module</a>
        As for
        <a href="/how-to-compile">OpenGeode configuration and compilation</a>,
      ...
      <p :class="paragraph">
        ...
        <a href="/how-to-compile">here</a>). You also need to have compiled or
        installed OpenGeode.
      </p>
      ...
      <p :class="paragraph">
        ...
        Follow the same
        <a href="/how-to-compile">procedure</a> than for OpenGeode but by
        specifying the <code>CMAKE_PREFIX_PATH</code> to OpenGeode install path.
      </p>
      ...
      <p :class="paragraph">
        If the module depends on several modules (for instance
        OpenGeode-GeosciencesIO that depends on OpenGeode and
        OpenGeode-Geosciences), do the following:
      </p>
      <code
        >cmake
