...
# class GeodeCommonOrchestratorSurfaceException
...
### GeodeCommonOrchestratorSurfaceException

```cpp
public void GeodeCommonOrchestratorSurfaceException(std::any data, TYPE type, const Args &... message)
```
