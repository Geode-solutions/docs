...
# class GeodeCommonCutterSolidException
...
### GeodeCommonCutterSolidException

```cpp
public void GeodeCommonCutterSolidException(std::any data, TYPE type, const Args &... message)
```
