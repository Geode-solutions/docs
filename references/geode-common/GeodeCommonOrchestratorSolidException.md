...
# class GeodeCommonOrchestratorSolidException
...
### GeodeCommonOrchestratorSolidException

```cpp
public void GeodeCommonOrchestratorSolidException(std::any data, TYPE type, const Args &... message)
```
