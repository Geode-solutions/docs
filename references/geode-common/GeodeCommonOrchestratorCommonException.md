...
# class GeodeCommonOrchestratorCommonException
...
### GeodeCommonOrchestratorCommonException

```cpp
public void GeodeCommonOrchestratorCommonException(std::any data, TYPE type, const Args &... message)
```
