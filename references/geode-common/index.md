...
* [BRepMedialBallExtractor](BRepMedialBallExtractor.md)
...
* [GeodeCommonCoreException](GeodeCommonCoreException.md)
* [GeodeCommonCoreLibrary](GeodeCommonCoreLibrary.md)
* [GeodeCommonCutterModelException](GeodeCommonCutterModelException.md)
* [GeodeCommonCutterModelLibrary](GeodeCommonCutterModelLibrary.md)
* [GeodeCommonCutterSolidException](GeodeCommonCutterSolidException.md)
* [GeodeCommonCutterSolidLibrary](GeodeCommonCutterSolidLibrary.md)
* [GeodeCommonCutterSurfaceException](GeodeCommonCutterSurfaceException.md)
* [GeodeCommonCutterSurfaceLibrary](GeodeCommonCutterSurfaceLibrary.md)
* [GeodeCommonException](GeodeCommonException.md)
* [GeodeCommonHelpersException](GeodeCommonHelpersException.md)
* [GeodeCommonHelpersLibrary](GeodeCommonHelpersLibrary.md)
* [GeodeCommonMetricException](GeodeCommonMetricException.md)
* [GeodeCommonMetricLibrary](GeodeCommonMetricLibrary.md)
* [GeodeCommonModifierCommonException](GeodeCommonModifierCommonException.md)
* [GeodeCommonModifierCommonLibrary](GeodeCommonModifierCommonLibrary.md)
* [GeodeCommonModifierEdgedCurveException](GeodeCommonModifierEdgedCurveException.md)
* [GeodeCommonModifierEdgedCurveLibrary](GeodeCommonModifierEdgedCurveLibrary.md)
* [GeodeCommonModifierGraphException](GeodeCommonModifierGraphException.md)
* [GeodeCommonModifierGraphLibrary](GeodeCommonModifierGraphLibrary.md)
* [GeodeCommonModifierModelException](GeodeCommonModifierModelException.md)
* [GeodeCommonModifierModelLibrary](GeodeCommonModifierModelLibrary.md)
* [GeodeCommonModifierPointSetException](GeodeCommonModifierPointSetException.md)
* [GeodeCommonModifierPointSetLibrary](GeodeCommonModifierPointSetLibrary.md)
* [GeodeCommonModifierSolidException](GeodeCommonModifierSolidException.md)
* [GeodeCommonModifierSolidLibrary](GeodeCommonModifierSolidLibrary.md)
* [GeodeCommonModifierSurfaceException](GeodeCommonModifierSurfaceException.md)
* [GeodeCommonModifierSurfaceLibrary](GeodeCommonModifierSurfaceLibrary.md)
* [GeodeCommonNumericsException](GeodeCommonNumericsException.md)
* [GeodeCommonNumericsLibrary](GeodeCommonNumericsLibrary.md)
* [GeodeCommonOrchestratorCommonException](GeodeCommonOrchestratorCommonException.md)
* [GeodeCommonOrchestratorCommonLibrary](GeodeCommonOrchestratorCommonLibrary.md)
* [GeodeCommonOrchestratorModelException](GeodeCommonOrchestratorModelException.md)
* [GeodeCommonOrchestratorModelLibrary](GeodeCommonOrchestratorModelLibrary.md)
* [GeodeCommonOrchestratorSolidException](GeodeCommonOrchestratorSolidException.md)
* [GeodeCommonOrchestratorSolidLibrary](GeodeCommonOrchestratorSolidLibrary.md)
* [GeodeCommonOrchestratorSurfaceException](GeodeCommonOrchestratorSurfaceException.md)
* [GeodeCommonOrchestratorSurfaceLibrary](GeodeCommonOrchestratorSurfaceLibrary.md)
...
* [ModelMedialBallExtractor](ModelMedialBallExtractor.md)
...
* [SectionMedialBallExtractor](SectionMedialBallExtractor.md)
...
```cpp
std::optional<PolygonVertex> edge_tshape_apex(const TriangulatedSurface<dimension> & mesh, const PolygonEdge & edge)
```
...
```cpp
ALLOWED_COLLAPSE_VERTEX_VERTEX allowed_collapse_edge_by_constraints(const ModifiableBRep & brep, const Block3D & block, const PolyhedronFacetEdge & edge, const BRepGeometricConstraintModifier::Constraints & constraints)
```
...
```cpp
ElementPartitions mesh_partitionner(const EdgedCurve<dimension> & mesh, const PartitionnerParameters & parameters)
```
...
```cpp
bool is_swap_edge_allowed_by_constraints(const ModifiableBRep & brep, const Block3D & block, const PolyhedronFacetEdge & edge, index_t apex, const BRepEdgeTShape & tshapes, const BRepGeometricConstraintModifier::Constraints & constraints)
```

### facet_tshape_apex

```cpp
std::optional<PolyhedronVertex> facet_tshape_apex(const TetrahedralSolid3D & mesh, const PolyhedronFacet & facet)
```
...
```cpp
bool is_swap_edge_allowed_by_constraints(const ModifiableTetrahedralSolid & solid, const PolyhedronFacetEdge & edge, index_t apex, const std::optional<SolidEdgeTShape> & tshape, const TetrahedralSolidConstraintModifier::Constraints & constraints)
```
...
```cpp
ElementPartitions mesh_partitionner(const SurfaceMesh<dimension> & mesh, const PartitionnerParameters & parameters)
```
...
```cpp
std::vector<GeometricSolidPath> determine_cuts(const TetrahedralSolid3D & solid, absl::Span<const SolidPath> path_splits)
```
...
```cpp
ElementPartitions mesh_partitionner(const SolidMesh3D & mesh, const PartitionnerParameters & parameters)
```
...
```cpp
bool is_swap_facet_allowed_by_constraints(const ModifiableBRep & brep, const Block3D & block, const PolyhedronFacet & facet, const BRepFacetTShape & tshape_apexes, const BRepGeometricConstraintModifier::Constraints & constraints)
```
...
```cpp
SolidCutPathInfo cut_along_path(const TetrahedralSolid3D & solid, TetrahedralSolidModifier & modifier, absl::Span<const GeometricSolidPath> path_splits)
```
...
```cpp
std::vector<GeometricSolidPath> determine_cuts(const TetrahedralSolid3D & solid, const Plane & plane, absl::Span<const SolidPath> path_splits)
```
...
```cpp
bool is_swap_facet_allowed_by_constraints(const ModifiableTetrahedralSolid & solid, const PolyhedronFacet & facet, const std::optional<PolyhedronVertex> & tshape_apex, const TetrahedralSolidConstraintModifier::Constraints & constraints)
```
...
```cpp
SolidCutPatchInfo cut_along_patch(const TetrahedralSolid3D & solid, TetrahedralSolidModifier & modifier, std::vector<FrontCycle> boundary_cycles, const Triangle3D & triangle)
```
...
```cpp
std::tuple<ALLOWED_COLLAPSE_EDGE_VERTEX, ForbiddenInfos> allowed_split_collapse_edge_by_constraints(const ModifiableTetrahedralSolid & solid, const PolyhedronFacetEdge & edge, index_t apex, const std::optional<SolidEdgeTShape> & tshape, const TetrahedralSolidConstraintModifier::Constraints & constraints)
```
...
```cpp
std::tuple<ALLOWED_COLLAPSE_EDGE_VERTEX, BlockForbiddenInfos> allowed_split_collapse_edge_by_constraints(const ModifiableBRep & brep, const Block3D & block, const PolyhedronFacetEdge & edge, index_t apex, const BRepEdgeTShape & tshapes, const BRepGeometricConstraintModifier::Constraints & constraints)
```
...
```cpp
std::tuple<ALLOWED_COLLAPSE_FACET_VERTEX, ForbiddenInfos> allowed_split_collapse_facet_by_constraints(const ModifiableTetrahedralSolid & solid, const PolyhedronFacet & facet, const std::optional<PolyhedronVertex> & tshape_apex, const TetrahedralSolidConstraintModifier::Constraints & constraints)
```
...
```cpp
std::tuple<ALLOWED_COLLAPSE_FACET_VERTEX, BlockForbiddenInfos> allowed_split_collapse_facet_by_constraints(const ModifiableBRep & brep, const Block3D & block, const PolyhedronFacet & facet, const BRepFacetTShape & tshape_apexes, const BRepGeometricConstraintModifier::Constraints & constraints)
```
...
```cpp
bool is_move_point_allowed_by_constraints(const ModifiableTetrahedralSolid & solid, index_t vertex, const TetrahedralSolidConstraintModifier::Constraints & constraints)
```
...
```cpp
InternalDistances fast_tetrahedron_internal_distances(const TetrahedralSolid3D & solid, index_t tetrahedron_id, const InternalDistance::Options & options)
```
...
```cpp
InternalDistances fast_triangle_internal_distances(const TriangulatedSurface<dimension> & surface, index_t triangle_id, const InternalDistance::Options & options)
```
...
```cpp
InternalDistances fast_tetrahedron_internal_distances(const Tetrahedron & tetra, const InternalDistance::Options & options)
```
...
```cpp
InternalDistances fast_triangle_internal_distances(const Triangle<dimension> & triangle, const InternalDistance::Options & options)
```
...
```cpp
InternalDistance::ELEMENT_STATUS tetrahedron_status(const Tetrahedron & tetrahedron)
```
...
```cpp
InternalDistance::ELEMENT_STATUS triangle_status(const Triangle<dimension> & triangle)
```
...
```cpp
std::optional<index_t> compute_number_of_negative_tetrahedra(absl::Span<const Tetrahedron> tetrahedra)
```
...
```cpp
std::optional<index_t> compute_number_of_negative_tetrahedra(absl::Span<const ModifiedTetrahedron> tetrahedra)
```
...
```cpp
std::optional<index_t> compute_number_of_negative_triangles(absl::Span<const Triangle<dimension>> triangles)
```
...
```cpp
std::optional<index_t> compute_number_of_negative_triangles(absl::Span<const ModifiedTriangle<dimension>> triangles)
```
...
```cpp
std::vector<geode::index_t> new_indices(absl::Span<const MappingType> mappings)
```
