...
# class GeodeCommonModifierSolidException
...
### GeodeCommonModifierSolidException

```cpp
public void GeodeCommonModifierSolidException(std::any data, TYPE type, const Args &... message)
```
