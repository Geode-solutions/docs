...
# class GeodeCommonModifierCommonException
...
### GeodeCommonModifierCommonException

```cpp
public void GeodeCommonModifierCommonException(std::any data, TYPE type, const Args &... message)
```
