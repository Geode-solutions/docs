...
# class GeodeCommonModifierSurfaceException
...
### GeodeCommonModifierSurfaceException

```cpp
public void GeodeCommonModifierSurfaceException(std::any data, TYPE type, const Args &... message)
```
