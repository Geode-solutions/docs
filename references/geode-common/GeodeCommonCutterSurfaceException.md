...
# class GeodeCommonCutterSurfaceException
...
### GeodeCommonCutterSurfaceException

```cpp
public void GeodeCommonCutterSurfaceException(std::any data, TYPE type, const Args &... message)
```
