...
# class GeodeCommonModifierModelException
...
### GeodeCommonModifierModelException

```cpp
public void GeodeCommonModifierModelException(std::any data, TYPE type, const Args &... message)
```
