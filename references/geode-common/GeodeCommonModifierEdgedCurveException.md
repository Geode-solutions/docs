...
# class GeodeCommonModifierEdgedCurveException
...
### GeodeCommonModifierEdgedCurveException

```cpp
public void GeodeCommonModifierEdgedCurveException(std::any data, TYPE type, const Args &... message)
```
