...
# class GeodeCommonModifierPointSetException
...
### GeodeCommonModifierPointSetException

```cpp
public void GeodeCommonModifierPointSetException(std::any data, TYPE type, const Args &... message)
```
