...
# class GeodeCommonModifierGraphException
...
### GeodeCommonModifierGraphException

```cpp
public void GeodeCommonModifierGraphException(std::any data, TYPE type, const Args &... message)
```
