...
# class GeodeCommonOrchestratorModelException
...
### GeodeCommonOrchestratorModelException

```cpp
public void GeodeCommonOrchestratorModelException(std::any data, TYPE type, const Args &... message)
```
