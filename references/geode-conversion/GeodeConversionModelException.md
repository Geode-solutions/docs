...
# class GeodeConversionModelException


```cpp
Inherits from GeodeConversionException
```
...
### GeodeConversionModelException

```cpp
public void GeodeConversionModelException(std::any data, TYPE type, const Args &... message)
```
