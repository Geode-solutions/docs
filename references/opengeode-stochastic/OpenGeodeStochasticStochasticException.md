...
# class OpenGeodeStochasticStochasticException


```cpp
Inherits from OpenGeodeStochasticException
```
...
```cpp
public void OpenGeodeStochasticStochasticException(std::any data, TYPE type, const Args &... message)
```
