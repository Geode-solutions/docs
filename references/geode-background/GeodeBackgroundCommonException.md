...
# class GeodeBackgroundCommonException
...
### GeodeBackgroundCommonException

```cpp
public void GeodeBackgroundCommonException(std::any data, TYPE type, const Args &... message)
```
