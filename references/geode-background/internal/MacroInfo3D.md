...
```cpp
public void add_macro_facet_to_background_solid_vertices(const MeshPolygon & macro_facet, absl::Span<const index_t> background_solid_vertex_ids, MacroInfo3DKey )
```
...
```cpp
public void remove_macro_facet_from_background_solid_vertices(const MeshPolygon & macro_facet, absl::Span<const index_t> background_solid_vertex_ids, MacroInfo3DKey )
```
