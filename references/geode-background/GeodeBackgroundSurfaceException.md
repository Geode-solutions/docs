...
# class GeodeBackgroundSurfaceException


```cpp
Inherits from GeodeBackgroundException
```
...
### GeodeBackgroundSurfaceException

```cpp
public void GeodeBackgroundSurfaceException(std::any data, TYPE type, const Args &... message)
```
