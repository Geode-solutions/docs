...
# class GeodeSimplexSurface3dException
...
### GeodeSimplexSurface3dException

```cpp
public void GeodeSimplexSurface3dException(std::any data, TYPE type, const Args &... message)
```
