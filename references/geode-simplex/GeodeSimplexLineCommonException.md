...
# class GeodeSimplexLineCommonException
...
### GeodeSimplexLineCommonException

```cpp
public void GeodeSimplexLineCommonException(std::any data, TYPE type, const Args &... message)
```
