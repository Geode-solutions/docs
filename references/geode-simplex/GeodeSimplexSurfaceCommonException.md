...
# class GeodeSimplexSurfaceCommonException


```cpp
Inherits from GeodeSimplexException
```
...
### GeodeSimplexSurfaceCommonException

```cpp
public void GeodeSimplexSurfaceCommonException(std::any data, TYPE type, const Args &... message)
```
