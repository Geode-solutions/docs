...
* [GeodeSimplexBRepException](GeodeSimplexBRepException.md)
* [GeodeSimplexBRepInspectionException](GeodeSimplexBRepInspectionException.md)
* [GeodeSimplexBRepLibrary](GeodeSimplexBRepLibrary.md)
* [GeodeSimplexCoreException](GeodeSimplexCoreException.md)
* [GeodeSimplexCoreLibrary](GeodeSimplexCoreLibrary.md)
* [GeodeSimplexCornerException](GeodeSimplexCornerException.md)
* [GeodeSimplexCornerLibrary](GeodeSimplexCornerLibrary.md)
* [GeodeSimplexException](GeodeSimplexException.md)
* [GeodeSimplexLine2dException](GeodeSimplexLine2dException.md)
* [GeodeSimplexLine2dLibrary](GeodeSimplexLine2dLibrary.md)
* [GeodeSimplexLine3dException](GeodeSimplexLine3dException.md)
* [GeodeSimplexLine3dLibrary](GeodeSimplexLine3dLibrary.md)
...
* [GeodeSimplexSolidException](GeodeSimplexSolidException.md)
* [GeodeSimplexSolidLibrary](GeodeSimplexSolidLibrary.md)
* [GeodeSimplexSurface2dException](GeodeSimplexSurface2dException.md)
* [GeodeSimplexSurface2dLibrary](GeodeSimplexSurface2dLibrary.md)
* [GeodeSimplexSurface3dException](GeodeSimplexSurface3dException.md)
* [GeodeSimplexSurface3dLibrary](GeodeSimplexSurface3dLibrary.md)
* [GeodeSimplexSurfaceCommonException](GeodeSimplexSurfaceCommonException.md)
* [GeodeSimplexSurfaceCommonLibrary](GeodeSimplexSurfaceCommonLibrary.md)
...
```cpp
BRepSamplingData::Tasks sample_lines(BRepSamplingData & data)
```
...
```cpp
BRepSamplingData::Tasks sample_blocks(BRepSamplingData & data)
```
...
```cpp
BRepSamplingData::Tasks sample_surfaces(BRepSamplingData & data)
```
...
```cpp
BRepSamplingData::Tasks sample_blocks(BRepSamplingData & data, BRepSamplingData::Tasks & surface_tasks)
```
...
```cpp
BRepSamplingData::Tasks sample_surfaces(BRepSamplingData & data, BRepSamplingData::Tasks & line_tasks)
```
...
```cpp
GenericMapping<index_t> constrained_mesh_block(const BRep & output, BRepBuilder & builder, const Block3D & block, std::vector<Point3D> && internal_points)
```
