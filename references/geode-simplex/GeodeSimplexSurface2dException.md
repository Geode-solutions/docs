...
# class GeodeSimplexSurface2dException
...
### GeodeSimplexSurface2dException

```cpp
public void GeodeSimplexSurface2dException(std::any data, TYPE type, const Args &... message)
```
