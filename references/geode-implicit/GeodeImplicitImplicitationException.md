...
# class GeodeImplicitImplicitationException
...
### GeodeImplicitImplicitationException

```cpp
public void GeodeImplicitImplicitationException(std::any data, TYPE type, const Args &... message)
```
