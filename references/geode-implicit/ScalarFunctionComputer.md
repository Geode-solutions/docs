...
```cpp
public void compute_scalar_function(double function_value_interval, const ImplicitationParameters & computation_parameters)
```
...
```cpp
protected void interpolate_result_on_grid(const CutGrid<dimension> & other_grid)
```
