...
# class GeodeImplicitWorkflowsException
...
### GeodeImplicitWorkflowsException

```cpp
public void GeodeImplicitWorkflowsException(std::any data, TYPE type, const Args &... message)
```
