...
```cpp
public std::vector<SurfaceImplicitInfo> compute_implicit_in_surfaces(const ImplicitationParameters & computation_parameters, const uuid & implicit_attribute_id)
```
