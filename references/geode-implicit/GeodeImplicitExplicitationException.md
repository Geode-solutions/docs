...
# class GeodeImplicitExplicitationException
...
### GeodeImplicitExplicitationException

```cpp
public void GeodeImplicitExplicitationException(std::any data, TYPE type, const Args &... message)
```
