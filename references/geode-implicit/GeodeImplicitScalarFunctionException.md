...
# class GeodeImplicitScalarFunctionException


```cpp
Inherits from GeodeImplicitException
```
...
### GeodeImplicitScalarFunctionException

```cpp
public void GeodeImplicitScalarFunctionException(std::any data, TYPE type, const Args &... message)
```
