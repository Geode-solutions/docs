...
# class GeodeViewablesQEMProxyException
...
### GeodeViewablesQEMProxyException

```cpp
public void GeodeViewablesQEMProxyException(std::any data, TYPE type, const Args &... message)
```
