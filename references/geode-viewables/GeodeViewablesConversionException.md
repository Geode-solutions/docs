...
# class GeodeViewablesConversionException


```cpp
Inherits from GeodeViewablesException
```
...
### GeodeViewablesConversionException

```cpp
public void GeodeViewablesConversionException(std::any data, TYPE type, const Args &... message)
```
