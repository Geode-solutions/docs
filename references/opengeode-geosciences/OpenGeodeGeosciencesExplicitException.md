...
# class OpenGeodeGeosciencesExplicitException
...
### OpenGeodeGeosciencesExplicitException

```cpp
public void OpenGeodeGeosciencesExplicitException(std::any data, TYPE type, const Args &... message)
```
