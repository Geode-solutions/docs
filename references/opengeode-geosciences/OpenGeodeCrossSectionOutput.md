...
```cpp
public void OpenGeodeCrossSectionOutput(std::string_view filename)
```
...
```cpp
public void save_cross_section_files(const CrossSection & cross_section, std::string_view directory)
```
