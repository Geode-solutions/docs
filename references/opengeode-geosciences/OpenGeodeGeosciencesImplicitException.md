...
# class OpenGeodeGeosciencesImplicitException


```cpp
Inherits from OpenGeodeGeosciencesException
```
...
### OpenGeodeGeosciencesImplicitException

```cpp
public void OpenGeodeGeosciencesImplicitException(std::any data, TYPE type, const Args &... message)
```
