...
```cpp
public void OpenGeodeHorizonsStackInput<dimension>(std::string_view filename)
```
...
```cpp
public void load_horizons_stack_files(HorizonsStack<dimension> & horizons_stack, std::string_view directory)
```
