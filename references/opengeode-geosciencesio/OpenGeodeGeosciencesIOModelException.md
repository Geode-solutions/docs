...
# class OpenGeodeGeosciencesIOModelException


```cpp
Inherits from OpenGeodeGeosciencesIOException
```
...
### OpenGeodeGeosciencesIOModelException

```cpp
public void OpenGeodeGeosciencesIOModelException(std::any data, TYPE type, const Args &... message)
```
