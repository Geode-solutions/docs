...
# class OpenGeodeGeosciencesIOMeshException
...
### OpenGeodeGeosciencesIOMeshException

```cpp
public void OpenGeodeGeosciencesIOMeshException(std::any data, TYPE type, const Args &... message)
```
