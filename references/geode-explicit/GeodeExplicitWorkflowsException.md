...
# class GeodeExplicitWorkflowsException


```cpp
Inherits from GeodeExplicitException
```
...
### GeodeExplicitWorkflowsException

```cpp
public void GeodeExplicitWorkflowsException(std::any data, TYPE type, const Args &... message)
```
