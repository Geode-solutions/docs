...
# class GeodeExplicitGeosciencesGeosciencesException


```cpp
Inherits from GeodeExplicitGeosciencesException
```
...
### GeodeExplicitGeosciencesGeosciencesException

```cpp
public void GeodeExplicitGeosciencesGeosciencesException(std::any data, TYPE type, const Args &... message)
```
