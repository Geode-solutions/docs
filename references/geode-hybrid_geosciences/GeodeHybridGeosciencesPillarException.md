...
# class GeodeHybridGeosciencesPillarException


```cpp
Inherits from GeodeHybridGeosciencesException
```
...
### GeodeHybridGeosciencesPillarException

```cpp
public void GeodeHybridGeosciencesPillarException(std::any data, TYPE type, const Args &... message)
```
