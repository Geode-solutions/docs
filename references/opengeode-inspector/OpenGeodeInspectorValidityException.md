...
# class OpenGeodeInspectorValidityException


```cpp
Inherits from OpenGeodeInspectorException
```
...
### OpenGeodeInspectorValidityException

```cpp
public void OpenGeodeInspectorValidityException(std::any data, TYPE type, const Args &... message)
```
