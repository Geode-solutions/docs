...
# class GeodeHybridFrameFieldException


```cpp
Inherits from GeodeHybridException
```
...
### GeodeHybridFrameFieldException

```cpp
public void GeodeHybridFrameFieldException(std::any data, TYPE type, const Args &... message)
```
